...
type Case {
  ...
  client(where: ContactWhereInput, orderBy: ContactOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Contact!]
...
input CaseWhereInput {
  ...
  client_every: ContactWhereInput
  client_some: ContactWhereInput
  client_none: ContactWhereInput
...
input ContactScalarWhereInput {
  ...
  id_not_ends_with: ID
  contactType: contactType
  contactType_not: contactType
  contactType_in: [contactType!]
  contactType_not_in: [contactType!]
  firstName: String
  ...
  socialSecurity: Int
  socialSecurity_not: Int
  socialSecurity_in: [Int!]
  socialSecurity_not_in: [Int!]
  socialSecurity_lt: Int
  socialSecurity_lte: Int
  socialSecurity_gt: Int
  socialSecurity_gte: Int
  cellPhone: Int
  cellPhone_not: Int
  cellPhone_in: [Int!]
  cellPhone_not_in: [Int!]
  cellPhone_lt: Int
  cellPhone_lte: Int
  cellPhone_gt: Int
  cellPhone_gte: Int
